                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                >
                                <a class="dropdown-item" href="#" @click="setSoftDelete(file)"
...
export default {
    ...
    methods: {
        ...
        setSoftDelete(file) {
            if (this.file.softDeleteFile(file.id)) {
                return console.log("deleted file");
            }
        }
    },
    mounted() {
        if (this.route.name === "files") {
            this.userFiles = this.filtered_files;
        }
        if (this.route.name === "shared-files") {
            console.log(this.shared_files)
            this.userFiles = this.shared_files;
        }
        if (this.route.name === "trash") {
            console.log(this.deleted_files)
